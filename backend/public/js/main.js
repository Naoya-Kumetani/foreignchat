...
var room = document.getElementById('room'); // import InfiniteLoading from 'vue-infinite-loading'; // ライブラリの読み込み
    ...
    fetchChats: function fetchChats() {
      ...
      axios.get("/member/".concat(room.dataset.memberId, "/fetch"), {
        ...
        if (response.data.chats.length) {
          _this.page++;
          response.data.chats.forEach(function (value) {
            _this.chats.unshift(value);
          });
        }
...
module.exports = __webpack_require__(/*! C:\Users\naoh1\docker-laravel\backend\resources\js\main.js */"./resources/js/main.js");
